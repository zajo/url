    ...
    string_view s)
{
    ...
    auto const n = s.size();
    auto const dest =
        pt_.resize(detail::id_scheme, n + 1);
    s.copy(dest, n);
    dest[n] = ':';
    return *this;
}
    ...
    string_view s)
{
    if(s.empty())
    {
        ...
        // retain '@'
        *pt_.resize(detail::id_password, 1) = '@';
        return *this;
    }
